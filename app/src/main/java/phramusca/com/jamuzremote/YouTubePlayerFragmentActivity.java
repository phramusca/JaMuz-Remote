...
public class YouTubePlayerFragmentActivity extends YouTubeBaseActivity {
    public static final String API_KEY = "AIzaSyBx7v0YOb140fDO7EbfMx4l87raxezDWFw"; //FIXME !!!! Get my own key

    //https://www.youtube.com/watch?v=<VIDEO_ID>
    //public static final String VIDEO_ID = "-m3V8w_7vhk"; //FIXME !!!!!! Make this a param
    public static final String VIDEO_ID = "w1K8lsjQ3mM";
//
    @Override
