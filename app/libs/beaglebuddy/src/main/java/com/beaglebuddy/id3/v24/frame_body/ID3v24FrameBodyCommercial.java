 ...
 * </table>
 * <p class="beaglebuddy">
 * A <i>commercial</i> frame body is associated with an ID3v2.4 {@link com.beaglebuddy.id3.enums.v24.FrameType#COMMERCIAL COMR} {@link com.beaglebuddy.id3.v24.ID3v24Frame frame} which allows vendors to include a price offer in an .mp3 file.
 ...
 *    </thead>
 *    <tbody>
 *       <tr><td class="beaglebuddy">1. </td><td class="beaglebuddy">{@link com.beaglebuddy.id3.enums.v24.Encoding encoding}         </td><td class="beaglebuddy">character set used to {@link #setEncoding(Encoding) encode} the <i>seller</i> and <i>description</i> fields.                                                          </td></tr>
 ...
 * </p>
 * <p>
 * There may be more than one <i>commercial</i> frame in an ID3v2.4 {@link com.beaglebuddy.id3.v24.ID3v24Tag tag}, but only one with the same seller.
 * </p>
...
public class ID3v24FrameBodyCommercial extends ID3v24FrameBody
{
    ...
    */
   public ID3v24FrameBodyCommercial(Encoding encoding, List<Price> prices, String validUntil, String contactURL, ReceivedType receivedAs, String seller, String description, String pictureMimeType, byte[] sellerLogo)
   {
    ...
    */
   public ID3v24FrameBodyCommercial(InputStream inputStream, int frameBodySize) throws IOException
   {
